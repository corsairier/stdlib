...
tape( 'if provided a non-integer value for any parameter, the function returns `NaN`', opts, function test( t ) {
	var y = pmf( 1.0, 1, 2.2 );
	t.equal( isnan( y ), true, 'returns NaN' );
...
tape( 'the function evaluates the pmf for `x` given a small range `b - a`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function evaluates the pmf for `x` given a medium range `b - a`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
...
tape( 'the function evaluates the pmf for `x` given a large range `b - a`', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var x;
